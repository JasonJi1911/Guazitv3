...
<head>
    ...
    <script src="jianghu/js/setting.js?v=2021"></script>
    <?php
    if ($p2p == "1") {
        ?>
...
<script>
    ...
    var config = {
        ...
        "bbslist": [
            {
                "link": "<?php echo $_GET["ad_link"];?>",
                "pic": "<?php echo $_GET["ad_type"] == 'img'? $_GET["ad_url"] : '';?>",
                "video": "<?php echo $_GET["ad_type"] == 'mp4'? $_GET["ad_url"] : '';?>"
            },
        ],
    }
    YZM.start();
