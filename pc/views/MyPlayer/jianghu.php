...
<script type="text/javascript">
    ...
    //<div class='palyer-js' data-index='choose' style='margin:0 5px 0 15px;'>选集</div>
    var txt1 = "<div class='palyer-js "+player_last_chapter+"' data-index='last'>上一集</div><div class='palyer-js "+player_next_chapter+"' data-index='next'>下一集</div>";
    ...
    function initialPlayer(e) {
        ...
        //1：当是1080时，提示720线路。2：当时720，提示1080线路，当只有一条线路，则提示：如果卡顿，请在播放窗口右侧联系客服；
        var strtext = "<div id='player-load1-warn'>如果卡顿，请在播放窗口右侧联系客服</div>";
        var source_count = <?=$source_count?>;
        if(source_count > 1){
            <?php if($source_id=="17" || $source_id=="19") : ?>
                strtext = "<div id='player-load1-warn'>如果卡顿，请在<span>播放窗口右侧</span>更换<span>720P</span>线路</div>";
            <?php else : ?>
                strtext = "<div id='player-load1-warn'>如果卡顿，请在<span>播放窗口右侧</span>更换<span>1080P</span>线路</div>";
            <?php endif;?>
        }
    ...
    $("#player1").on('click', '.palyer-js', function() {
        ...
        if(index=='choose'){
            ...
            if(last_chapter>0){
                ...
                loadvideo(videoid,last_chapter,sourceId);
            ...
            if(next_chapter>0){
                var videoid = '<?=$videos[0]['video_id']?>';
                var sourceId = $('.sourceTab .hover a').attr('data-source-id');
                loadvideo(videoid,next_chapter,sourceId);
