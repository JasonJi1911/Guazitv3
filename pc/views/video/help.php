            ...
            <div class="hlp-forget-pass-sub J_safe_auth">
                ...
                <div class="help-pass-box J_step_two3">
                    <div class="inp-box pasbox">
                        ...
                        <input type="password" class="inp pas J_new_pass" name="" placeholder="请输入密码" value="" onkeyup="value=value.replace(/[^(\w-*\.*)]/g,'')" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;" autocomplete="off">
                        <input type="button" class="eye" value="">
                    </div>
                    <div class="inp-box pasbox">
                        <span class="inp-title">确认密码</span>
                        <input type="password" class="inp pas J_sure_pass" name="" placeholder="请再次输入密码" value="" onkeyup="value=value.replace(/[^(\w-*\.*)]/g,'')" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;" autocomplete="off">
                        <input type="button" class="eye" value="">
                    </div>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div class="hlp-text06">
                            ...
                            作为海外视频行业领先者，<?= $name ?>
                            为澳洲华人120万用户提供全面网络服务，致力于打造涵盖多种视频类型的海外华人视频分享平台。在这里您可以看到来自全球各地华人制作，分享的各类影视资讯，新闻热点等。同时，作为海外视频行业领先者，<?= $name ?>
