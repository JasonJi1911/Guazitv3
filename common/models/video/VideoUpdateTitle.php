...
/**
 * This is the model class for table "{{%video_update_title}}".
 *
 ...
 */
class VideoUpdateTitle extends \xiang\db\ActiveRecord implements StatusToggleInterface
{
