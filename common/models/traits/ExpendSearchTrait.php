...
use common\models\Expend;

/**
 * 消费记录搜索Trait
 */
trait ExpendSearchTrait
{
    /**
     * @var string 关键词
     */
    ...
    public function rules()
    {
        return [
            [['keyword'], 'trim'],
            [['from_channel', 'type', 'time', 'search_uid'], 'integer'],
...
//        $query->andWhere(['type' => Expend::TYPE_BUY_TEXT]);
    ...
    public function prepareQuery($query)
    {
        ...
        if ($this->search_uid) {
            $query->andWhere(['uid' => $this->search_uid]);
        }
