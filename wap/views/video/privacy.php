...
?>
<style>
    #privacy{width: 100%;height:calc(100% - 1rem);}
</style>
<div class="display-flex outer-div sms-title pink" >
    ...
    <div class="text-center title-width">隐私政策</div>
    <div class="div-box position-r"></div>
</div>
<iframe id="privacy" src="<?=$data['about'][1]['content']?>" align="center" width="100%" scrolling="auto" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
<script>
    ...
    window.onload = function () {
        setIframeHeight(document.getElementById('privacy'));
    };
</script>