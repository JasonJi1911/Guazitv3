...
<div class="caption" style="padding:0 0;">
    <div class="tabbable-line">
        <ul class="nav nav-tabs">
            <li class="<?= $type == 'gold' ? 'active' : ''?>">
                <a href="<?= Url::to(['expend/index'])?>"> 金币明细 </a>
            </li>
            <li class="<?= $type == 'income' ? 'active' : ''?>">
                <a href="<?= Url::to(['user-remain-log/index'])?>"> 现金明细 </a>
            </li>
        </ul>
    </div>
</div>
