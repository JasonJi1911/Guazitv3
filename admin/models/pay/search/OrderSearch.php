...
use common\models\traits\OrderSearchTrait;
use common\models\traits\SearchInterface;
use yii\data\ActiveDataProvider;


class OrderSearch extends Order implements SearchInterface
{
    ...
    public function rules()
    {
        return [
            [['keyword'], 'trim'],
            [['from_channel', 'pay_channel', 'status', 'time', 'lid', 'type'], 'integer'],
