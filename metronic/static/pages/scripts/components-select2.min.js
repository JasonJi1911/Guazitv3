var ComponentsSelect2 = function () {
    var e = function () {
        function e(e) {
            ...
            var t = "<div class='select2-result-repository clearfix'><div class='select2-result-repository__avatar'><img src='" + e.avatar + "' /></div><div class='select2-result-repository__meta'><div class='select2-result-repository__title'>" + e.full_name + "</div>";
        ...
        $(".select2, .select2-multiple").select2({
            ...
            width: "off",
            ajax: {
                url: "/video/actor-search", dataType: "json", delay: 250, data: function (e) {
